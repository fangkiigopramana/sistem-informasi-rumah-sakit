        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-8 mb-3">
                <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                    ...
                    <form action="/data-pasien" method="post">
                        @csrf
                        <div class="container mt-3 mb-3">
                            <div class="form-group row">
                                <label for="pasien_nama" class="col-sm-2 col-form-label">Nama Pasien</label>
                                <input type="text" class="col-sm-8 form-control @error('pasien_nama') is-invalid @enderror" id="pasien_nama" name="pasien_nama" value="{{ old('pasien_nama') }}" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <input type="number" class="col-sm-8 form-control @error('umur') is-invalid @enderror" id="umur" name="umur" {{ old('umur') }}>
                                <div class="invalid-feedback text-center">
                                    @error('umur')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="col-sm-8 form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" {{ old('alamat') }}>
                                <div class="invalid-feedback text-center">
                                    @error('alamat')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <input type="email" class="col-sm-8 form-control @error('email') is-invalid @enderror" id="email" name="email" {{ old('email') }}>
                                <div class="invalid-feedback text-center">
                                    @error('email')
                                        {{ $message }}
                                    @enderror
